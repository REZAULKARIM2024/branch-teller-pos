...
public class HelpPanel extends JPanel {
    ...
    private void buildTopics() {
        ...
        topics.put("18. Approvals (Maker-Checker, Manager+)",
                ...
                + "<p>When a teller submits a withdrawal or transfer larger than their personal approval "
                + "limit, it lands here instead of executing immediately &mdash; a standard \"maker-checker\" "
                + "dual control so no single person can move large sums alone.</p>"
                + "<ol>"
                + "<li>Review the request: type, accounts, amount, who requested it, and their note.</li>"
                + "<li>Select it and click <b>Approve &amp; Execute</b> to actually perform the transfer/"
                + "withdrawal, or <b>Reject</b> to decline it &mdash; either way you can add a decision note.</li>"
                + "</ol>"
                + "<p>Every user's approval limit is shown on their own <b>Security</b> tab. Managers and "
                + "Admins have very high limits by default so their own transactions rarely queue.</p>");
        ...
        topics.put("19. General Ledger (Manager+)",
                ...
                + "balanced debit and credit automatically. This tab has three sub-tabs across the top.</p>"
                ...
                + "account with a running balance, like a classic T-account. The ending balance is shown below "
                + "the table.</p>"
