...
ALTER TABLE customers ADD COLUMN IF NOT EXISTS credit_score INT NULL;
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS otp_required BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS approval_limit DECIMAL(15,2) NOT NULL DEFAULT 5000.00;
